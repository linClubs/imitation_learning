    ...
    with torch.inference_mode():
        while True and not rospy.is_shutdown():
            ...
            while t < max_publish_step and not rospy.is_shutdown():
                ...
                ros_operator.arm_joint_state_puppet_publish_interpolation(left_action, right_action)  # puppet_arm_publish_continuous_thread
                if args.use_robot_base:
    ...
    def arm_joint_state_puppet_publish_interpolation(self, left, right):
        ...
        while True and arm_left is None and arm_right is None and not rospy.is_shutdown():
            ...
            if arm_left is None or arm_right is None:
                ...
                break
        # print(arm_left.shape)
        # print(arm_right.shape)
        ...
        if max(arm_diff) > 0.5:
            ...
            while flag and not rospy.is_shutdown():
                ...
                # self.arm_joint_state_puppet_publish(left, right)
                step += 1
                rate.sleep()
        else:
